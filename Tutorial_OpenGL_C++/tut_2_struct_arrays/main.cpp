...
const unsigned int pCount = 1000;
...
void tmMovePoints(int value){
    ...
    for(int i=0; i<pCount; i++){
        points[i].pos_x = (float) i/pCount * (cos(  (float) i/pCount * angle * 3.14 / 180.0   ))
                * cos(  (float) i/pCount * angle * 3.14 / 180.0   );

        points[i].pos_y = (float) i/pCount * cos(  (float) i/pCount * angle * 3.14 / 180.0   )
                * sin((float) i/pCount * angle * 3.14 / 180.0);
    }
